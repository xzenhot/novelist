Use 20 main chapters, one introductory chapter, and one conclusion chapter.
...
7. override - Human-in-the-loop transformation layer. Reads filter.md for instructions; passes through unchanged if empty.
8. quality - Quality audit result. Human-in-the-loop gate; reads filter.md for instructions; passes through unchanged if empty.
