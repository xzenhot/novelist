...
6. Record the theme in `.space/pipeline/book_<bookname>/filters/5_theme/<n>.json`.
...
Record the theme assignment and its contemporary mapping in `.space/pipeline/book_<bookname>/filters/5_theme/<n>.json`.
